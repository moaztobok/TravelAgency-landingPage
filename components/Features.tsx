...
const FeatureItem =({title,description,icon}:FeatureItem)=>
    <li className='flex flex-w-full flex-1 flex-col items-start '>
      <div className='rounded-full p-4 lg:p-7 bg-green-50'>
        <Image src={icon} alt='map'
        width={28}
        height={28}/>
      </div>
...
const Features = () => {
  return (
    <section className='flex-col flexCenter overflow-hidden bg-feature-bg bg-center bg-no-repeat py-60 '>
